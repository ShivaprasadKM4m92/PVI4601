...
//		"{PVI_URL}");
	...
	lr_start_transaction("ViewCaseBCE_04_IntakeQueueMyCases");
...
//		"application/json, text/javascript, */*; q=0.01");
	...
	lr_end_transaction("ViewCaseBCE_04_IntakeQueueMyCases", LR_AUTO);


	lr_start_transaction("ViewCaseBCE_05_IntakeQueueAllCases");
	...
	lr_end_transaction("ViewCaseBCE_05_IntakeQueueAllCases",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("ViewCaseBCE_06_FilterIntakeCaseNum");
...
/*Correlation comment - Do not change!  Original value='244399' Name ='CaseId' Type ='Manual'*/
	...
	lr_end_transaction("ViewCaseBCE_06_FilterIntakeCaseNum",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("ViewCaseBCE_07_ViewCase_BCE");
...
//		"*/*");
	...
	lr_end_transaction("ViewCaseBCE_07_ViewCase_BCE",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("ViewCaseBCE_08_Back");
...
//		"application/json, text/javascript, */*; q=0.01");
	...
	lr_end_transaction("ViewCaseBCE_08_Back",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("ViewCaseBCE_09_NavigatePVAdmin");
	...
	lr_end_transaction("ViewCaseBCE_09_NavigatePVAdmin",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("ViewCaseBCE_10_Logout");
	...
	lr_end_transaction("ViewCaseBCE_10_Logout",LR_AUTO);
