...
//		"application/json, text/javascript, */*; q=0.01");
	...
	lr_start_transaction("ViewCaseFCE_05_IntakeQueueAllCases");
	...
	lr_end_transaction("ViewCaseFCE_05_IntakeQueueAllCases",LR_AUTO);
...
Type ='Manual'*/
	...
	lr_start_transaction(lr_eval_string("ViewCaseFCE_06_ViewCase_FCE_{CaseType}"));
...
//		"*/*");
	...
	lr_end_transaction(lr_eval_string("ViewCaseFCE_06_ViewCase_FCE_{CaseType}"),LR_AUTO);
...
//		"*/*");
	...
	lr_start_transaction("ViewCaseFCE_11_Logout");
	...
	lr_end_transaction("ViewCaseFCE_11_Logout",LR_AUTO);
